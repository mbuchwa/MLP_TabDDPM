...
def sample(
    ...
    model.load_state_dict({key: checkpoint['state_dict'][f'ema_model.{key}'] for key in model_state_keys})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='exp/churn2/ddpm_mlp_best/config.toml')
    ...
    sample(
        ...
        **raw_config['diffusion_params'],
        ...
        model_path='/home/marcus/PycharmProjects/msc-mm/logs/lightning_logs/version_37/checkpoints/epoch=499-step=12500.ckpt',
